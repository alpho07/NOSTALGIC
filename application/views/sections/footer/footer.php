<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2015-<?php echo date('Y'); ?> <a href="<?php echo @$sys_name[0]->website;?>"><?php echo @$sys_name[0]->footer;?></a>. </strong> All rights reserved.
</footer>
...
<script src="<?php echo base_url(); ?>dist/js/jquery-impromptu.js"></script>
<script src="<?php echo base_url(); ?>dist/js/notify.min.js"></script>
<script src="<?php echo base_url(); ?>dist/js/source/jquery.fancybox.js"></script>
