    ...
    <body class="hold-transition login-page" style="background: url(<?php echo base_url(); ?>images/PlayStation_logo1.jpg); padding-bottom: 1px; ">
        ...
        <div class="register-box" style="display: none;">
            ...
            <div class="register-logo">
                <span style="color:white;"><b>PS PALOUR</b> REGISTRATION</span>
            </div><!-- /.login-logo -->

            <div class="register-box-body">

                <p class="register-box-msg">Register to become a valued member</p>
		...
		$('#result').html(checkStrength($('#rpassword').val()))
                ...
                $register = function () {
                    ...
                    if ($('#rname').val() === '') {
                        ...
                        $.post(base_url + 'doRegister/', $data, function () {
                            swal({
                                title: "Sweet!",
